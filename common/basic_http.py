...
class MyRequest(object):
    myresponse = ''
    #header={}
    header=device.DICT__HTTP_HEADERS_002


    def __init__(self,url,dict_data,headers=header):
        ...
        #self.headers=device.DICT__HTTP_HEADERS_002
   ...
   #--------------------decode_errorinfo_------------------------------------------------
    ...
    def decode_res_info(self,ret):
        ...
        if error_no!=0 and error_no!=13 :
            ...
            if 'errormsg' in response_json_dict:
