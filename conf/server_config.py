...
DICT__HTTP_HEADERS_001 = {"User-Agent": "Mozilla/5.0",
                     "Content-Type": 'application/json;charset=UTF-8'

                        }

DICT__HTTP_HEADERS_002 = {'Content-Type': 'application/x-www-form-urlencoded', 'User-Agent': 'Mozilla/4.0'}


DICT__SYS_HEADERS = {"User-Agent": "Mozilla/5.0",
                     "Content-Type": 'application/json;charset=UTF-8',
